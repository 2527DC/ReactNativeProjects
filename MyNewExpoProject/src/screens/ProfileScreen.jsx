...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-gray-100">
      <View className="p-5">
        {/* Profile Header Card */}
        <Card className="mb-4 rounded-2xl bg-white shadow-md">
          <View className="items-center p-6">
            <Image
              source={require('./images.jpg')} // Replace with your image path
              className="w-[120px] h-[120px] rounded-full border-4 border-blue-500"
            />
...
{nameChange?<Card className="p-4 rounded-xl mb-4 border border-gray-300">
           <View className="flex-row items-center p-2">
            <TextInput
              className="flex-1 border border-gray-300 rounded-md p-2"
                    placeholder="Enter Name"
                   />
             <TouchableOpacity className="p-2 m-2 bg-blue-500 rounded-md">
